        ...
        <div class="panel-collapse panel panel-default">
            <div class="panel-heading">
                ...
                <h5 class="panel-title">
                    <b>
                        <asp:Label ID="lbl_outer_panel" runat="server" Text="Employee Office Mapping Not Allocated"></asp:Label>
                    </b>
                </h5>
                <div>
                    ...
                    <div class="panel-body" style="background-color: #f9f8f8;">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2">
                                          <asp:Label ID="Label1" runat="server" Text="Select Permissions:"></asp:Label>
                                ...
                                <div style="width: 100%; margin: 0px auto; text-align: center; padding: 10px 0px;">
                                    ...
                                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="button button-3d button-black nomargin btn btn-primary" ValidationGroup="vg" OnClick="btnSubmit_Click" />
                                </div>
