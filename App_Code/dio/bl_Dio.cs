...
/// <summary>
/// Summary description for bl_Dio
/// </summary>
public class bl_Dio
{
    string office, base_department, district, employee,state, officelvl, userid, officelevelecode;
    string address, contact, fax, email, url, officeid, country, category;
    string welcomepage, active, role, rollName;
    string status, todate, fromdate, ofc_mappingid, type, ipaddress, clientos, client_browser, useragent,useros;
    string filedata; 
    ...
    public string File_data { get { return filedata; } set { filedata = value; } }
}